...
```{r score-dist, warning=FALSE}
# type your code for Question 3 here, and Knit
fig <- plot_ly(data=evals, x=~score, type="histogram")
fig
summary(evals$score)
```
...
```{r p-val-select}
# type your code for the Exercise here, and Knit
m_full_no_cls_profs <- lm(score ~ rank + ethnicity + gender + language + age + cls_perc_eval 
