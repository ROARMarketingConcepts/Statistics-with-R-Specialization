---
title: "Statistics with R Capstone Project: Lab II - Model Selection & Diagnostics"
author: Ken Wood
date: 6/19/21
...
5. Suppose you want to model  $\log$(`price`) using only the variables in the dataset that pertain to quality: `Overall.Qual`, `Bsmt.Qual`, and `Garage.Qual`.  How many observations must be discarded in order to estimate this model?
<ol>
<li> 0
<li> 46
<li> **64**
