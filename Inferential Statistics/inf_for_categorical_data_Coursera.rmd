...
us12 %>%                               # Create tibble with frequencies
  group_by(response) %>%
  summarise(n = n()) %>%
  mutate(freq = n / sum(n))
```
...
inference(y = response, data = spain_2005, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

spain_2012 <- atheism %>%
  filter(nationality == "Spain" ,atheism$year == "2012")

inference(y = response, data = spain_2012, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
...
inference(y = response, data = usa_2005, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")

usa_2012 <- atheism %>%
  filter(nationality == "United States" ,atheism$year == "2012")

inference(y = response, data = usa_2012, statistic = "proportion", type = "ci", method = "theoretical", success = "atheist")
```
